...
// Express Request type removed - using generic request objects instead
...
class SDKServer {
  ...
  async authenticateRequest(req: any): Promise<AuthenticatedUser> {
    ...
    if (user.isBanned) {
      throw ForbiddenError(`Your account has been banned. Reason: ${user.banReason || 'No reason provided'}`);
    }
